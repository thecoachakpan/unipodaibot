...
- **Technical Support Email**: uaisupport@mit.edu`
  },
  {
    ...
    content: `### Wadhwani Ignite Track Guidelines & Module 1 Coaching Rules
...
- **Problem Statement Rules**: Focus strictly on WHO suffers, WHAT happens, and WHY. **Do NOT mention your solution, product name, or AI features.** Activity 1.1 = max 350 chars; Activity 1.3 = max 150 chars.
- **Beneficiary vs. Paying Customer**: Distinguish the entity suffering pain (beneficiary) from the entity paying for the solution (paying customer; e.g. government, donors, CSR, enterprise B2B).
